...
const RecommendationResults = dynamic(
  () => import("@/components/RecommendationResults"),
  {
    loading: () => (
      ...
      <div className="max-w-7xl mx-auto space-y-6 md:space-y-8">
        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="mt-6 text-slate-600">
            Intelligent shopping recommendations powered by multi-agent AI
          </p>
        </div>

        {/* Search */}
        <UserSearch onSearch={debouncedSearch} loading={loading} />
        ...
        {!loading && recommendation && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 mt-4 md:mt-8">
            <div className="md:col-span-1">
              <UserProfile profile={recommendation.user_profile} />
            </div>
